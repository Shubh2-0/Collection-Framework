...
//	p1.add("Shubham");
    ...
    p1.add(10);   // return true if added else throw exception
	p1.offer(11); //return true if added else false
...
/*  
   POINTS TO BE REMEMBER ABOUT PRIORITY QUEUE
    ...
    5.NULL value is not supported, we can not store null in priority queue  
    6.size is DYNAMIC 	
